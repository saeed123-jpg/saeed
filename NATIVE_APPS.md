...
زر "تحميل التطبيق" داخل الموقع يشرح مسارات التطبيقات الحقيقية. ملفات `EXE` و`APK` لا تُبنى داخل المتصفح، بل من التيرمنل، ثم يمكن رفعها لاحقا إلى GitHub Releases أو أي صفحة تحميل.

إذا ظهر لك زر قديم باسم "تثبيت التطبيق"، فهذا من كاش المتصفح القديم وليس من الكود الجديد. افتح الموقع بعد التحديث مرة أخرى أو اعمل تحديثا كاملا للصفحة، وسيقوم ملف التنظيف `public/sw.js` بإلغاء عامل التثبيت القديم وحذف كاشه.
